 ...
 * @param text
 */
const Skittles: React.FunctionComponent<PropTypes> = ({
  text,
  style,
  mods,
}) => {
  ...
  return (
    <span
      ...
      className={`u-textCenter u-borderRadiusMd u-fontSizeXs u-padXs ${
        colorMap[colorHash]
      }${intensityHash + 3} ${intensityHash >= 2 ? 'u-colorNeutral1' : ''} ${
        mods ? mods : ''
      }`}
    >
      {text.substr(0, 2)}
